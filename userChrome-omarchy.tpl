...
:root {
	/* Use actual CSS variables from imported colors.css */
	--tab-active-bg-color: @background;
	--tab-inactive-bg-color: @background;
	--tab-active-fg-fallback-color: @color5;		/* color of text in an active tab without a container */
	--tab-inactive-fg-fallback-color: @color4;		/* color of text in an inactive tab without a container */
	--urlbar-focused-bg-color: @background;
	--urlbar-not-focused-bg-color: @background;
	--toolbar-bgcolor: @background !important;
	--identity-icon-color: @accent !important;
	--tab-font: 'ShureTechMono Nerd Font Mono';
	--urlbar-font: 'ShureTechMono Nerd Font Mono';
...
.tab-icon-stack:not([pinned]):not([busy]) { display: none !important; }
...
/* numbering tabs */
#tabbrowser-tabs { counter-reset: tab-counter; }
.tabbrowser-tab { counter-increment: tab-counter; }
...
.tabbrowser-tab .tab-content::before {
	...
	margin-right: 0.5em;
	padding: var(--tab-min-height) 0.4em;
	color: @color5;
